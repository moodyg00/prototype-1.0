...
export function TableHead({
  ...
  return (
    <th
      className={cn(
        "h-9 whitespace-nowrap px-2 text-left align-middle font-medium text-muted-foreground leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className,
      )}
...
export function TableCell({
  ...
  return (
    <td
      className={cn(
        "whitespace-nowrap bg-clip-padding px-2 py-2 in-data-[slot=table-footer]:py-3.5 align-middle leading-none in-data-[variant=card]:first:ps-[calc(--spacing(2)-1px)] in-data-[variant=card]:last:pe-[calc(--spacing(2)-1px)] has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className,
      )}
