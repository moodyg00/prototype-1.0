...
// Auto-generated from workflow: Memory Ingest (with review)
// Workflow ID: cmr0xcx5700083kac0evv9c7c
// Generated: 2026-06-30T17:32:43.939Z
...
async function review(state: typeof StateAnnotation.State) {
  interrupt("Review tagged chunks before writing to Chroma. Resume to upsert.");
  return {};
}
...
builder.addEdge('embed', 'review');
builder.addEdge('review', 'upsert');
